...
void Renderer::Render(Snake const snake, SDL_Point const &food, SDL_Point const &obstacle) {
  ...
  //std::cout <<"Food renderer, x: "<<obstacle.x<<" y: "<<obstacle.y<<std::endl;
  ...
  //std::cout <<"Obstacle renderer, x: "<<obstacle.x<<" y: "<<obstacle.y<<std::endl;
  //std::cout <<"grid height , x: "<<grid_height<<" width : "<<grid_width<<std::endl;
  SDL_RenderFillRect(sdl_renderer, &block);
